...
- `mqtt.max_connect_user_properties` limits how many `User-Property` pairs a CONNECT may carry, counted separately for the CONNECT properties and the will properties. Default: `100`.
...
Clients that send unusually large credentials or last-will payloads, or more than 100 user properties in CONNECT, need the matching setting raised.
