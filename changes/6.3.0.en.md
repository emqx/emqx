...
- [#17222](https://github.com/emqx/emqx/pull/17222) Added a Bigtable Connector and Action for appending data to Bigtable.
...
- [#17607](https://github.com/emqx/emqx/pull/17607) [#17998](https://github.com/emqx/emqx/pull/17998) Added a v2 topic-metrics surface with named collections, wildcard topic filters,
  ...
  it is marked deprecated in its Swagger spec; integrations should
  use v2.
...
- [#18453](https://github.com/emqx/emqx/pull/18453) Added the `security_profile_divergence` alarm.
  ...
  list while the alarm is active. The alarm clears on its own once every running
