...
- [#10278](https://github.com/emqx/emqx/pull/10278) SSL MQTT监听器增加对 OCSP Stapling 的支持。
...
- [#10385](https://github.com/emqx/emqx/pull/10385) 从配置文件和文档中隐藏数据项（`rule_engine/bridge/authz/authn`）。
