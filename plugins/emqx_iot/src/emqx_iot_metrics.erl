...
init() ->
    ...
    AllMetrics = [
        'batch_pub_qos0_in', 'batch_pub_qos0_error',
        'batch_pub_qos0_targeted', 'batch_pub_qos0_delivered', 'batch_pub_qos0_skipped',
        'batch_pub_qos1_in', 'batch_pub_qos1_error', 'batch_pub_qos1_incomplete',
        'batch_pub_qos1_delivered_inline', 'batch_pub_qos1_stored_offline',
        'broadcast_pub_in', 'broadcast_pub_error',
        'broadcast_pub_devices_online', 'broadcast_pub_delivery_count',
        'register_message_in', 'register_message_refresh', 'register_message_error',
        'batch_pub_qos1_msg_wanted', 'batch_pub_qos1_msg_succeed', 'batch_pub_qos1_msg_acked',
        'batch_pub_qos1_msg_replayed', 'batch_pub_qos1_msg_error',
        'batch_pub_qos1_msg_incomplete', 'batch_pub_qos1_msg_pending'
    ],
