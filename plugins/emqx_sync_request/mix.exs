defmodule EMQXSyncRequest.MixProject do
  use Mix.Project

  def project do
    [
      app: :emqx_sync_request,
      version: version(),
  ...
  defp emqx_plugin do
    [
      ...
      metadata: [
        ...
        functionality: ["Synchronous MQTT request over HTTP"],
        compatibility: [
          emqx: "~> #{emqx_major_minor()}"
        ],
        description: "Synchronous MQTT request plugin for EMQX."
      ]
    ]
  end
