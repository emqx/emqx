...
- Load plugin management modules and run stale-package cleanup so nodes that missed a plugin uninstall while disconnected reconcile local packages with cluster config during hot upgrade.
