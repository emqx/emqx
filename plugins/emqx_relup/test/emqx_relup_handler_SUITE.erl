...
-doc "The shipped catalog declares no upgrade hop: 5.10.4 -> 5.10.5 is not supported.".
t_shipped_catalog_has_no_hops(_Config) ->
    ?assertEqual([], emqx_relup_handler:list_supported_paths()).
