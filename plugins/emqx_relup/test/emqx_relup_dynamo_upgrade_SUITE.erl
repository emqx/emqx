...
-module(emqx_relup_dynamo_upgrade_SUITE).
...
t_restart_dynamo_connectors_skips_stopped_resources(_Config) ->
    Running = <<"dynamo-running">>,
    Stopped = <<"dynamo-stopped">>,
    Missing = <<"dynamo-missing">>,
    ...
    ok = emqx_relup_dynamo_upgrade:restart_dynamo_connectors(),
