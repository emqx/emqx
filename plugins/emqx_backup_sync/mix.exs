defmodule EMQXBackupSync.MixProject do
  use Mix.Project

  def project do
    [
      app: :emqx_backup_sync,
      version: version(),
  ...
  defp emqx_plugin do
    [
      ...
      metadata: [
        ...
        functionality: ["Backup synchronization"],
        compatibility: [
          emqx: "~> #{emqx_major_minor()}"
        ],
        description: "Synchronize selected backup data from a primary EMQX cluster."
      ]
    ]
  end
