defmodule EMQXMaptabs.MixProject do
  use Mix.Project
  ...
  defp emqx_plugin do
    [
      ...
      metadata: [
        ...
        functionality: ["Rule engine mapping tables"],
        compatibility: [
          emqx: "~> #{emqx_major_minor()}"
        ],
        description: "Named mapping tables and a maptab_lookup rule SQL function."
      ]
    ]
  end
