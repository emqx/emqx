...
## example:
## ./scripts/buildx.sh --profile emqx --pkgtype zip --builder ghcr.io/emqx/emqx-builder/4.4-11:24.1.5-3-debian10 --arch arm64
...
help() {
    ...
    echo "                     E.g. ghcr.io/emqx/emqx-builder/4.4-11:24.1.5-3-debian10"
}
