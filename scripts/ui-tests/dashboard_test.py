...
def test_log(driver, login, dashboard_url):
    ...
    label = driver.find_element(By.XPATH, "//div[@id='app']//form//label[./span[text()='Enable Log Handler']]")
    assert driver.find_elements(By.ID, label.get_attribute("for"))
    label = driver.find_element(By.XPATH, "//div[@id='app']//form//label[./span[text()='Log Level']]")
    assert driver.find_elements(By.ID, label.get_attribute("for"))
    label = driver.find_element(By.XPATH, "//div[@id='app']//form//label[./span[text()='Log Formatter']]")
    assert driver.find_elements(By.ID, label.get_attribute("for"))
    label = driver.find_element(By.XPATH, "//div[@id='app']//form//label[./span[text()='Time Offset']]")
    assert driver.find_elements(By.ID, label.get_attribute("for"))
