...
->
    #{
        ...
        case InfluxDBType of
            apiv1_tcp ->
                #{
                    host => os:getenv("INFLUXDB_APIV1_TCP_HOST", "influxdb_tcp"),
                    port => list_to_integer(os:getenv("INFLUXDB_APIV1_TCP_PORT", "8086")),
                    use_tls => false
                };
            apiv1_tls ->
                #{
                    host => os:getenv("INFLUXDB_APIV1_TLS_HOST", "influxdb_tls"),
                    port => list_to_integer(os:getenv("INFLUXDB_APIV1_TLS_PORT", "8086")),
                    use_tls => true
                }
        end,
...
->
    #{
        ...
        case InfluxDBType of
            apiv2_tcp ->
                #{
                    host => os:getenv("INFLUXDB_APIV2_TCP_HOST", "influxdb_tcp"),
                    port => list_to_integer(os:getenv("INFLUXDB_APIV2_TCP_PORT", "8086")),
                    use_tls => false
                };
            apiv2_tls ->
                #{
                    host => os:getenv("INFLUXDB_APIV2_TLS_HOST", "influxdb_tls"),
                    port => list_to_integer(os:getenv("INFLUXDB_APIV2_TLS_PORT", "8086")),
                    use_tls => true
                }
        end,
    case emqx_common_test_helpers:is_tcp_server_available(InfluxDBHost, InfluxDBPort) of
