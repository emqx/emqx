...
rest_schema() ->
    ...
    DefinitionProperties = #{
        ...
        <<"messages.received">> =>
        #{type => <<"integer">>, description => <<"Number of messages received from the client, equal to the sum of messages.qos0.received，messages.qos1.received and messages.qos2.received">>},
        <<"messages.sent">> =>
        #{type => <<"integer">>, description => <<"Number of messages sent to the client, equal to the sum of messages.qos0.sent，messages.qos1.sent and messages.qos2.sent">>},
        <<"messages.retained">> =>
        ...
        <<"session.terminated">> =>
        #{type => <<"integer">>, description => <<"Number of terminated sessions">>}
    },
