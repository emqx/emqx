...
is_start_client_error(Error) ->
    is_invalid_plugin_config_error(Error) orelse
        is_conflicting_plugin_version_error(Error).

is_invalid_plugin_config_error({error, #{msg := "invalid_plugin_config"}}) -> true;
is_invalid_plugin_config_error(_) -> false.

is_conflicting_plugin_version_error(
    {error, #{msg := "conflicting_plugin_version_running"}}
) ->
    true;
