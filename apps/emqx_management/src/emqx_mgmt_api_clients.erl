...
properties(client) ->
    ...
    {'recv_msg.dropped', integer,
     <<"Number of Dropped PUBLISH packets received">>},
    {'recv_msg.dropped.expired', integer,
     <<"Number of Dropped Expired PUBLISH packets received">>},
    {recv_oct,          integer,
    ...
    {'send_msg.dropped', integer,
     <<"Number of Dropped PUBLISH packets sent">>},
    {'send_msg.dropped.expired', integer,
     <<"Number of Dropped Expired PUBLISH packets sent">>},
    {'send_msg.dropped.queue_full', integer,
     <<"Number of Dropped Queue Full PUBLISH packets sent">>},
    {'send_msg.dropped.too_large', integer,
     <<"Number of Dropped Too Large PUBLISH packets sent">>},
    {send_oct,          integer,
