...
t_list_clients_v2(Config) ->
    ...
    ?check_trace(
        begin
            ...
            %% one by one
            Res1 = list_all_v2(APIPort, #{limit => "1"}),
            ?assertMatch(
                [
                    #{
                        <<"data">> := [_],
            ...
            %% paging
            Res2 = list_all_v2(APIPort, #{limit => "4"}),
            ?assertMatch(
                [
                    #{
                        <<"data">> := [_, _, _, _],
            ...
            Res3 = list_all_v2(APIPort, #{limit => "2"}),
            ?assertMatch(
                [
                    #{
                        <<"data">> := [_, _],
            ...
            %% fuzzy filters
            Res4 = list_all_v2(APIPort, #{limit => "100", like_clientid => "ca"}),
            ?assertMatch(
                [
                    #{
                        <<"data">> := [_, _, _],
            ...
            Res5 = list_all_v2(APIPort, #{limit => "1", like_clientid => "ca"}),
            ?assertMatch(
                [
                    #{
                        <<"data">> := [_],
