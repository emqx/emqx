...
%%--------------------------------------------------------------------
-module(emqx_bridge_gcp_pubsub_consumer_grpc_connector_info).
...
-define(SCHEMA_MOD, emqx_bridge_gcp_pubsub_consumer_grpc_connector_schema).
...
resource_callback_module() ->
    emqx_bridge_gcp_pubsub_consumer_grpc_impl.
