...
decode_msg_provider_loaded_request(Bin, TrUserData) ->
    dfp_read_field_def_provider_loaded_request(Bin, 0, 0,
					       id('$undef', TrUserData),
					       TrUserData).
...
dfp_read_field_def_provider_loaded_request(<<10,
    ...
    d_field_provider_loaded_request_broker(Rest, Z1, Z2,
					   F@_1, TrUserData);
...
dfp_read_field_def_provider_loaded_request(Other, Z1,
					   Z2, F@_1, TrUserData) ->
    dg_read_field_def_provider_loaded_request(Other, Z1, Z2,
					      F@_1, TrUserData).
...
dg_read_field_def_provider_loaded_request(<<1:1, X:7,
    ...
    when N < 32 - 7 ->
    dg_read_field_def_provider_loaded_request(Rest, N + 7,
...
dg_read_field_def_provider_loaded_request(<<0:1, X:7,
    ...
    case Key of
      10 ->
	  d_field_provider_loaded_request_broker(Rest, 0, 0, F@_1,
						 TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_provider_loaded_request(Rest, 0, 0, F@_1,
						    TrUserData);
	    1 ->
		skip_64_provider_loaded_request(Rest, 0, 0, F@_1,
						TrUserData);
	    2 ->
		skip_length_delimited_provider_loaded_request(Rest, 0,
							      0, F@_1,
							      TrUserData);
	    3 ->
		skip_group_provider_loaded_request(Rest, Key bsr 3, 0,
						   F@_1, TrUserData);
	    5 ->
		skip_32_provider_loaded_request(Rest, 0, 0, F@_1,
						TrUserData)
	  end
    end;
...
d_field_provider_loaded_request_broker(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_provider_loaded_request_broker(Rest, N + 7,
					   X bsl N + Acc, F@_1, TrUserData);
d_field_provider_loaded_request_broker(<<0:1, X:7,
    ...
    dfp_read_field_def_provider_loaded_request(RestF, 0, 0,
...
skip_varint_provider_loaded_request(<<1:1, _:7,
				      Rest/binary>>,
				    Z1, Z2, F@_1, TrUserData) ->
    skip_varint_provider_loaded_request(Rest, Z1, Z2, F@_1,
					TrUserData);
skip_varint_provider_loaded_request(<<0:1, _:7,
				      Rest/binary>>,
				    Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_provider_loaded_request(Rest, Z1, Z2,
					       F@_1, TrUserData).
...
skip_length_delimited_provider_loaded_request(<<0:1,
    ...
    dfp_read_field_def_provider_loaded_request(Rest2, 0, 0,
					       F@_1, TrUserData).

skip_group_provider_loaded_request(Bin, FNum, Z2, F@_1,
				   TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_provider_loaded_request(Rest, 0, Z2,
					       F@_1, TrUserData).
...
decode_msg_loaded_response(Bin, TrUserData) ->
    dfp_read_field_def_loaded_response(Bin, 0, 0,
				       id([], TrUserData), TrUserData).

dfp_read_field_def_loaded_response(<<10, Rest/binary>>,
				   Z1, Z2, F@_1, TrUserData) ->
    d_field_loaded_response_hooks(Rest, Z1, Z2, F@_1,
				  TrUserData);
...
dfp_read_field_def_loaded_response(Other, Z1, Z2, F@_1,
				   TrUserData) ->
    dg_read_field_def_loaded_response(Other, Z1, Z2, F@_1,
				      TrUserData).
...
dg_read_field_def_loaded_response(<<1:1, X:7,
				  ...
				  N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_loaded_response(Rest, N + 7,
				      X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_loaded_response(<<0:1, X:7,
    ...
    case Key of
      10 ->
	  d_field_loaded_response_hooks(Rest, 0, 0, F@_1,
					TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_loaded_response(Rest, 0, 0, F@_1,
					    TrUserData);
	    1 ->
		skip_64_loaded_response(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_loaded_response(Rest, 0, 0, F@_1,
						      TrUserData);
	    3 ->
		skip_group_loaded_response(Rest, Key bsr 3, 0, F@_1,
					   TrUserData);
	    5 ->
...
d_field_loaded_response_hooks(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_loaded_response_hooks(Rest, N + 7,
				  X bsl N + Acc, F@_1, TrUserData);
d_field_loaded_response_hooks(<<0:1, X:7, Rest/binary>>,
    ...
    dfp_read_field_def_loaded_response(RestF, 0, 0,
				       cons(NewFValue, Prev, TrUserData),
				       TrUserData).

skip_varint_loaded_response(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    skip_varint_loaded_response(Rest, Z1, Z2, F@_1,
				TrUserData);
skip_varint_loaded_response(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_loaded_response(Rest, Z1, Z2, F@_1,
				       TrUserData).
...
skip_length_delimited_loaded_response(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_loaded_response(Rest, N + 7,
					  X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_loaded_response(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_loaded_response(Rest2, 0, 0, F@_1,
				       TrUserData).

skip_group_loaded_response(Bin, FNum, Z2, F@_1,
			   TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_loaded_response(Rest, 0, Z2, F@_1,
				       TrUserData).
...
decode_msg_provider_unloaded_request(Bin, TrUserData) ->
    dfp_read_field_def_provider_unloaded_request(Bin, 0, 0,
						 TrUserData).
...
dfp_read_field_def_provider_unloaded_request(Other, Z1,
					     Z2, TrUserData) ->
    dg_read_field_def_provider_unloaded_request(Other, Z1,
						Z2, TrUserData).
...
dg_read_field_def_provider_unloaded_request(<<1:1, X:7,
					    ...
					    N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_provider_unloaded_request(Rest, N + 7,
...
dg_read_field_def_provider_unloaded_request(<<0:1, X:7,
    ...
    case Key band 7 of
      0 ->
	  skip_varint_provider_unloaded_request(Rest, 0, 0,
						TrUserData);
      1 ->
	  skip_64_provider_unloaded_request(Rest, 0, 0,
					    TrUserData);
      2 ->
	  skip_length_delimited_provider_unloaded_request(Rest, 0,
							  0, TrUserData);
      3 ->
	  skip_group_provider_unloaded_request(Rest, Key bsr 3, 0,
					       TrUserData);
      5 ->
	  skip_32_provider_unloaded_request(Rest, 0, 0,
					    TrUserData)
    end;
...
skip_varint_provider_unloaded_request(<<1:1, _:7,
					Rest/binary>>,
				      Z1, Z2, TrUserData) ->
    skip_varint_provider_unloaded_request(Rest, Z1, Z2,
					  TrUserData);
skip_varint_provider_unloaded_request(<<0:1, _:7,
					Rest/binary>>,
				      Z1, Z2, TrUserData) ->
    dfp_read_field_def_provider_unloaded_request(Rest, Z1,
						 Z2, TrUserData).
...
skip_length_delimited_provider_unloaded_request(<<0:1,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_provider_unloaded_request(Rest2, 0,
						 0, TrUserData).

skip_group_provider_unloaded_request(Bin, FNum, Z2,
				     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_provider_unloaded_request(Rest, 0,
						 Z2, TrUserData).
...
dfp_read_field_def_session_terminated_request(<<18,
						Rest/binary>>,
					      Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_session_terminated_request_reason(Rest, Z1, Z2,
					      F@_1, F@_2, TrUserData);
...
dg_read_field_def_session_terminated_request(<<0:1, X:7,
    ...
    case Key of
	  ...
	  d_field_session_terminated_request_clientinfo(Rest, 0,
							...
							TrUserData);
      18 ->
	  d_field_session_terminated_request_reason(Rest, 0, 0,
						    F@_1, F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
...
d_field_session_terminated_request_reason(<<1:1, X:7,
					  ...
					  N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_session_terminated_request_reason(Rest, N + 7,
					      X bsl N + Acc, F@_1, F@_2,
					      TrUserData);
...
dfp_read_field_def_message_dropped_request(<<18,
					     Rest/binary>>,
					   Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_message_dropped_request_reason(Rest, Z1, Z2,
					   F@_1, F@_2, TrUserData);
...
dg_read_field_def_message_dropped_request(<<0:1, X:7,
    ...
    case Key of
	  ...
	  d_field_message_dropped_request_message(Rest, 0, 0,
						  F@_1, F@_2, TrUserData);
      18 ->
	  d_field_message_dropped_request_reason(Rest, 0, 0, F@_1,
						 F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_message_dropped_request(Rest, 0, 0, F@_1,
						    F@_2, TrUserData);
	    1 ->
		skip_64_message_dropped_request(Rest, 0, 0, F@_1, F@_2,
						TrUserData);
	    2 ->
		...
		skip_group_message_dropped_request(Rest, Key bsr 3, 0,
						   F@_1, F@_2, TrUserData);
	    5 ->
		skip_32_message_dropped_request(Rest, 0, 0, F@_1, F@_2,
						TrUserData)
	  end
    end;
...
d_field_message_dropped_request_reason(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_message_dropped_request_reason(Rest, N + 7,
					   X bsl N + Acc, F@_1, F@_2,
					   TrUserData);
...
decode_msg_valued_response(Bin, TrUserData) ->
    dfp_read_field_def_valued_response(Bin, 0, 0,
				       id('IGNORE', TrUserData),
				       id('$undef', TrUserData), TrUserData).

dfp_read_field_def_valued_response(<<8, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_valued_response_type(Rest, Z1, Z2, F@_1, F@_2,
				 TrUserData);
dfp_read_field_def_valued_response(<<24, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_valued_response_bool_result(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData);
dfp_read_field_def_valued_response(<<34, Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_valued_response_message(Rest, Z1, Z2, F@_1,
				    F@_2, TrUserData);
...
dfp_read_field_def_valued_response(Other, Z1, Z2, F@_1,
				   F@_2, TrUserData) ->
    dg_read_field_def_valued_response(Other, Z1, Z2, F@_1,
				      F@_2, TrUserData).
...
dg_read_field_def_valued_response(<<1:1, X:7,
				  ...
				  N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_valued_response(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_valued_response(<<0:1, X:7,
    ...
    case Key of
      8 ->
	  d_field_valued_response_type(Rest, 0, 0, F@_1, F@_2,
				       TrUserData);
      24 ->
	  d_field_valued_response_bool_result(Rest, 0, 0, F@_1,
					      F@_2, TrUserData);
      34 ->
	  d_field_valued_response_message(Rest, 0, 0, F@_1, F@_2,
					  TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_valued_response(Rest, 0, 0, F@_1, F@_2,
					    TrUserData);
	    1 ->
		skip_64_valued_response(Rest, 0, 0, F@_1, F@_2,
					TrUserData);
	    2 ->
		skip_length_delimited_valued_response(Rest, 0, 0, F@_1,
						      F@_2, TrUserData);
	    3 ->
		skip_group_valued_response(Rest, Key bsr 3, 0, F@_1,
					   F@_2, TrUserData);
	    5 ->
		skip_32_valued_response(Rest, 0, 0, F@_1, F@_2,
					TrUserData)
	  end
    end;
...
d_field_valued_response_type(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_valued_response_type(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, TrUserData);
d_field_valued_response_type(<<0:1, X:7, Rest/binary>>,
	...
	{id('d_enum_valued_response.ResponsedType'(begin
	    ...
	    TrUserData),
	 Rest},
    dfp_read_field_def_valued_response(RestF, 0, 0,
...
d_field_valued_response_bool_result(<<1:1, X:7,
				    ...
				    N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_valued_response_bool_result(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_valued_response_bool_result(<<0:1, X:7,
    ...
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0,
			     TrUserData),
			  Rest},
    dfp_read_field_def_valued_response(RestF, 0, 0, F@_1,
...
d_field_valued_response_message(<<1:1, X:7,
				...
				N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_valued_response_message(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, TrUserData);
...
skip_varint_valued_response(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_valued_response(Rest, Z1, Z2, F@_1, F@_2,
				TrUserData);
skip_varint_valued_response(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_valued_response(Rest, Z1, Z2, F@_1,
				       F@_2, TrUserData).
...
skip_length_delimited_valued_response(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_valued_response(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2,
					  TrUserData);
skip_length_delimited_valued_response(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_valued_response(Rest2, 0, 0, F@_1,
				       F@_2, TrUserData).

skip_group_valued_response(Bin, FNum, Z2, F@_1, F@_2,
			   TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_valued_response(Rest, 0, Z2, F@_1,
				       F@_2, TrUserData).
...
decode_msg_broker_info(Bin, TrUserData) ->
    dfp_read_field_def_broker_info(Bin, 0, 0,
...
dfp_read_field_def_broker_info(<<10, Rest/binary>>, Z1,
    ...
    d_field_broker_info_version(Rest, Z1, Z2, F@_1, F@_2,
				F@_3, F@_4, TrUserData);
dfp_read_field_def_broker_info(<<18, Rest/binary>>, Z1,
			       Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    d_field_broker_info_sysdescr(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, TrUserData);
dfp_read_field_def_broker_info(<<26, Rest/binary>>, Z1,
			       Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    d_field_broker_info_uptime(Rest, Z1, Z2, F@_1, F@_2,
			       F@_3, F@_4, TrUserData);
dfp_read_field_def_broker_info(<<34, Rest/binary>>, Z1,
			       Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    d_field_broker_info_datetime(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, TrUserData);
...
dfp_read_field_def_broker_info(Other, Z1, Z2, F@_1,
			       F@_2, F@_3, F@_4, TrUserData) ->
    dg_read_field_def_broker_info(Other, Z1, Z2, F@_1, F@_2,
				  F@_3, F@_4, TrUserData).

dg_read_field_def_broker_info(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_broker_info(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				  TrUserData);
dg_read_field_def_broker_info(<<0:1, X:7, Rest/binary>>,
    ...
    case Key of
      10 ->
	  d_field_broker_info_version(Rest, 0, 0, F@_1, F@_2,
				      F@_3, F@_4, TrUserData);
      18 ->
	  d_field_broker_info_sysdescr(Rest, 0, 0, F@_1, F@_2,
				       F@_3, F@_4, TrUserData);
      26 ->
	  d_field_broker_info_uptime(Rest, 0, 0, F@_1, F@_2, F@_3,
				     F@_4, TrUserData);
      34 ->
	  d_field_broker_info_datetime(Rest, 0, 0, F@_1, F@_2,
				       F@_3, F@_4, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_broker_info(Rest, 0, 0, F@_1, F@_2, F@_3,
					F@_4, TrUserData);
	    1 ->
		skip_64_broker_info(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
				    TrUserData);
	    2 ->
		skip_length_delimited_broker_info(Rest, 0, 0, F@_1,
						  F@_2, F@_3, F@_4, TrUserData);
	    3 ->
		skip_group_broker_info(Rest, Key bsr 3, 0, F@_1, F@_2,
				       F@_3, F@_4, TrUserData);
	    5 ->
		skip_32_broker_info(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
				    TrUserData)
	  end
    end;
...
d_field_broker_info_version(<<1:1, X:7, Rest/binary>>,
			    N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_broker_info_version(Rest, N + 7, X bsl N + Acc,
				F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_broker_info_version(<<0:1, X:7, Rest/binary>>,
    ...
    dfp_read_field_def_broker_info(RestF, 0, 0, NewFValue,
				   F@_2, F@_3, F@_4, TrUserData).

d_field_broker_info_sysdescr(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_broker_info_sysdescr(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_broker_info_sysdescr(<<0:1, X:7, Rest/binary>>,
    ...
    dfp_read_field_def_broker_info(RestF, 0, 0, F@_1,
				   NewFValue, F@_3, F@_4, TrUserData).

d_field_broker_info_uptime(<<1:1, X:7, Rest/binary>>, N,
			   Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_broker_info_uptime(Rest, N + 7, X bsl N + Acc,
			       F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_broker_info_uptime(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_broker_info(RestF, 0, 0, F@_1, F@_2,
				   NewFValue, F@_4, TrUserData).

d_field_broker_info_datetime(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_broker_info_datetime(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, F@_3, F@_4, TrUserData);
...
skip_varint_broker_info(<<1:1, _:7, Rest/binary>>, Z1,
			Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    skip_varint_broker_info(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			    F@_4, TrUserData);
skip_varint_broker_info(<<0:1, _:7, Rest/binary>>, Z1,
			Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dfp_read_field_def_broker_info(Rest, Z1, Z2, F@_1, F@_2,
				   F@_3, F@_4, TrUserData).
...
skip_length_delimited_broker_info(<<1:1, X:7,
				  ...
				  N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    skip_length_delimited_broker_info(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				      TrUserData);
skip_length_delimited_broker_info(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_broker_info(Rest2, 0, 0, F@_1, F@_2,
				   F@_3, F@_4, TrUserData).

skip_group_broker_info(Bin, FNum, Z2, F@_1, F@_2, F@_3,
		       F@_4, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_broker_info(Rest, 0, Z2, F@_1, F@_2,
				   F@_3, F@_4, TrUserData).
...
decode_msg_hook_spec(Bin, TrUserData) ->
    dfp_read_field_def_hook_spec(Bin, 0, 0,
				 id(<<>>, TrUserData), id([], TrUserData),
				 TrUserData).

dfp_read_field_def_hook_spec(<<10, Rest/binary>>, Z1,
			     Z2, F@_1, F@_2, TrUserData) ->
    d_field_hook_spec_name(Rest, Z1, Z2, F@_1, F@_2,
			   TrUserData);
dfp_read_field_def_hook_spec(<<18, Rest/binary>>, Z1,
			     Z2, F@_1, F@_2, TrUserData) ->
    d_field_hook_spec_topics(Rest, Z1, Z2, F@_1, F@_2,
			     TrUserData);
...
dfp_read_field_def_hook_spec(Other, Z1, Z2, F@_1, F@_2,
			     TrUserData) ->
    dg_read_field_def_hook_spec(Other, Z1, Z2, F@_1, F@_2,
				TrUserData).

dg_read_field_def_hook_spec(<<1:1, X:7, Rest/binary>>,
			    N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_hook_spec(Rest, N + 7, X bsl N + Acc,
				F@_1, F@_2, TrUserData);
dg_read_field_def_hook_spec(<<0:1, X:7, Rest/binary>>,
    ...
    case Key of
      10 ->
	  d_field_hook_spec_name(Rest, 0, 0, F@_1, F@_2,
				 TrUserData);
      18 ->
	  d_field_hook_spec_topics(Rest, 0, 0, F@_1, F@_2,
				   TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_hook_spec(Rest, 0, 0, F@_1, F@_2,
				      TrUserData);
	    1 ->
		skip_64_hook_spec(Rest, 0, 0, F@_1, F@_2, TrUserData);
	    2 ->
		skip_length_delimited_hook_spec(Rest, 0, 0, F@_1, F@_2,
						TrUserData);
	    3 ->
		skip_group_hook_spec(Rest, Key bsr 3, 0, F@_1, F@_2,
				     TrUserData);
	    5 ->
...
d_field_hook_spec_name(<<1:1, X:7, Rest/binary>>, N,
    ...
    when N < 57 ->
    d_field_hook_spec_name(Rest, N + 7, X bsl N + Acc, F@_1,
			   F@_2, TrUserData);
d_field_hook_spec_name(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_hook_spec(RestF, 0, 0, NewFValue,
				 F@_2, TrUserData).

d_field_hook_spec_topics(<<1:1, X:7, Rest/binary>>, N,
			 Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_hook_spec_topics(Rest, N + 7, X bsl N + Acc,
			     F@_1, F@_2, TrUserData);
...
skip_length_delimited_hook_spec(<<1:1, X:7,
				...
				N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_hook_spec(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, TrUserData);
skip_length_delimited_hook_spec(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_hook_spec(Rest2, 0, 0, F@_1, F@_2,
				 TrUserData).

skip_group_hook_spec(Bin, FNum, Z2, F@_1, F@_2,
		     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_hook_spec(Rest, 0, Z2, F@_1, F@_2,
				 TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      provider_loaded_request ->
	  merge_msg_provider_loaded_request(Prev, New,
					    TrUserData);
      loaded_response ->
	  merge_msg_loaded_response(Prev, New, TrUserData);
      provider_unloaded_request ->
	  merge_msg_provider_unloaded_request(Prev, New,
					      TrUserData);
      client_connect_request ->
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      provider_loaded_request ->
	  v_msg_provider_loaded_request(Msg, [MsgName],
					TrUserData);
      loaded_response ->
	  v_msg_loaded_response(Msg, [MsgName], TrUserData);
      provider_unloaded_request ->
	  v_msg_provider_unloaded_request(Msg, [MsgName],
					  TrUserData);
      client_connect_request ->
...
v_msg_loaded_response(#{} = M, Path, TrUserData) ->
    case M of
	  ...
	  if is_list(F1) ->
		 ...
		 ok;
	     true ->
		 mk_type_error({invalid_list_of, {msg, hook_spec}}, F1,
			       [hooks | Path])
	  end;
      _ -> ok
    end,
...
v_msg_valued_response(#{} = M, Path, TrUserData) ->
    ...
    case M of
	  ...
	  v_type_bool(OF2, [bool_result, value | Path],
		      TrUserData);
      #{value := {message, OF2}} ->
...
get_msg_names() ->
    [provider_loaded_request, loaded_response,
     provider_unloaded_request, client_connect_request,
     client_connack_request, client_connected_request,
     client_disconnected_request,
     ...
     message_acked_request, empty_success, valued_response,
     broker_info, hook_spec, conn_info, client_info, message,
     property, topic_filter, sub_opts].
...
get_rpc_names('emqx.exhook.v1.HookProvider') ->
    ['OnProviderLoaded', 'OnProviderUnloaded',
     'OnClientConnect', 'OnClientConnack',
...
get_msg_containment("exhook") ->
    [broker_info, client_authenticate_request,
     ...
     client_subscribe_request, client_unsubscribe_request,
     conn_info, empty_success, hook_spec, loaded_response,
     message, message_acked_request,
     message_delivered_request, message_dropped_request,
     message_publish_request, property,
     provider_loaded_request, provider_unloaded_request,
