...
-export(['enum_symbol_by_value_client_authorize_request.AuthorizeReqType'/1, 'enum_value_by_symbol_client_authorize_request.AuthorizeReqType'/1]).
...
%% enumerated types
-type 'client_authorize_request.AuthorizeReqType'() :: 'PUBLISH' | 'SUBSCRIBE'.
-type 'valued_response.ResponsedType'() :: 'CONTINUE' | 'IGNORE' | 'STOP_AND_RETURN'.
-export_type(['client_authorize_request.AuthorizeReqType'/0, 'valued_response.ResponsedType'/0]).
...
-type client_authorize_request() ::
      #{clientinfo              => client_info(),   % = 1
        type                    => 'PUBLISH' | 'SUBSCRIBE' | integer(), % = 2, enum client_authorize_request.AuthorizeReqType
        topic                   => iodata(),        % = 3
...
-type session_takenover_request() ::
      #{clientinfo              => client_info()    % = 1
       }.
...
-export_type(['provider_loaded_request'/0, 'loaded_response'/0, 'provider_unloaded_request'/0, 'client_connect_request'/0, 'client_connack_request'/0, 'client_connected_request'/0, 'client_disconnected_request'/0, 'client_authenticate_request'/0, 'client_authorize_request'/0, 'client_subscribe_request'/0, 'client_unsubscribe_request'/0, 'session_created_request'/0, 'session_subscribed_request'/0, 'session_unsubscribed_request'/0, 'session_resumed_request'/0, 'session_discarded_request'/0, 'session_takenover_request'/0, 'session_terminated_request'/0, 'message_publish_request'/0, 'message_delivered_request'/0, 'message_dropped_request'/0, 'message_acked_request'/0, 'empty_success'/0, 'valued_response'/0, 'broker_info'/0, 'hook_spec'/0, 'conn_info'/0, 'client_info'/0, 'message'/0, 'property'/0, 'topic_filter'/0, 'sub_opts'/0]).

-spec encode_msg(provider_loaded_request() | loaded_response() | provider_unloaded_request() | client_connect_request() | client_connack_request() | client_connected_request() | client_disconnected_request() | client_authenticate_request() | client_authorize_request() | client_subscribe_request() | client_unsubscribe_request() | session_created_request() | session_subscribed_request() | session_unsubscribed_request() | session_resumed_request() | session_discarded_request() | session_takenover_request() | session_terminated_request() | message_publish_request() | message_delivered_request() | message_dropped_request() | message_acked_request() | empty_success() | valued_response() | broker_info() | hook_spec() | conn_info() | client_info() | message() | property() | topic_filter() | sub_opts(), atom()) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        ...
        client_authorize_request ->
            encode_msg_client_authorize_request(id(Msg, TrUserData),
                                                TrUserData);
        ...
        session_takenover_request ->
            encode_msg_session_takenover_request(id(Msg,
                                                    TrUserData),
                                                 TrUserData);
...
encode_msg_client_authorize_request(Msg, TrUserData) ->
    encode_msg_client_authorize_request(Msg,
                                        <<>>,
                                        TrUserData).


encode_msg_client_authorize_request(#{} = M, Bin,
                                    TrUserData) ->
    B1 = case M of
             #{clientinfo := F1} ->
                 begin
                     ...
                     if TrF1 =:= undefined -> Bin;
                        true ->
                            e_mfield_client_authorize_request_clientinfo(TrF1,
                                                                         <<Bin/binary,
                                                                           10>>,
                                                                         TrUserData)
                     end
             ...
             #{type := F2} ->
                 begin
                     ...
                     if TrF2 =:= 'PUBLISH'; TrF2 =:= 0 -> B1;
                        true ->
                            'e_enum_client_authorize_request.AuthorizeReqType'(TrF2,
                                                                               <<B1/binary,
                                                                                 16>>,
                                                                               TrUserData)
                     end
...
encode_msg_session_takenover_request(Msg, TrUserData) ->
    encode_msg_session_takenover_request(Msg,
                                         <<>>,
                                         TrUserData).


encode_msg_session_takenover_request(#{} = M, Bin,
                                     TrUserData) ->
    case M of
        #{clientinfo := F1} ->
            begin
                ...
                if TrF1 =:= undefined -> Bin;
                   true ->
                       e_mfield_session_takenover_request_clientinfo(TrF1,
                                                                     <<Bin/binary,
                                                                       10>>,
                                                                     TrUserData)
                end
...
encode_msg_message(#{} = M, Bin, TrUserData) ->
    ...
    case M of
        #{headers := F8} ->
            TrF8 = 'tr_encode_message.headers'(F8, TrUserData),
            if TrF8 == [] -> B7;
               true -> e_field_message_headers(TrF8, B7, TrUserData)
            end;
        _ -> B7
    end.
...
e_mfield_client_authorize_request_clientinfo(Msg, Bin,
                                             TrUserData) ->
    SubBin = encode_msg_client_info(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.
...
e_mfield_session_takenover_request_clientinfo(Msg, Bin,
                                              TrUserData) ->
    SubBin = encode_msg_client_info(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.
...
e_mfield_message_headers(Msg, Bin, TrUserData) ->
...
e_field_message_headers([Elem | Rest], Bin,
                        TrUserData) ->
    Bin2 = <<Bin/binary, 66>>,
    Bin3 =
        e_mfield_message_headers('tr_encode_message.headers[x]'(Elem,
                                                                TrUserData),
                                 Bin2,
                                 TrUserData),
    e_field_message_headers(Rest, Bin3, TrUserData);
e_field_message_headers([], Bin, _TrUserData) -> Bin.
...
'e_enum_client_authorize_request.AuthorizeReqType'('PUBLISH',
                                                   Bin, _TrUserData) ->
    <<Bin/binary, 0>>;
'e_enum_client_authorize_request.AuthorizeReqType'('SUBSCRIBE',
                                                   Bin, _TrUserData) ->
    <<Bin/binary, 1>>;
'e_enum_client_authorize_request.AuthorizeReqType'(V,
                                                   Bin, _TrUserData) ->
    e_varint(V, Bin).
...
decode_msg_2_doit(client_authenticate_request, Bin,
    ...
    id(decode_msg_client_authenticate_request(Bin,
                                              TrUserData),
       TrUserData);
decode_msg_2_doit(client_authorize_request, Bin,
                  TrUserData) ->
    id(decode_msg_client_authorize_request(Bin, TrUserData),
       TrUserData);
...
decode_msg_2_doit(session_discarded_request, Bin,
    ...
    id(decode_msg_session_discarded_request(Bin,
                                            TrUserData),
       TrUserData);
decode_msg_2_doit(session_takenover_request, Bin,
                  TrUserData) ->
    id(decode_msg_session_takenover_request(Bin,
                                            TrUserData),
       TrUserData);
...
decode_msg_client_authorize_request(Bin, TrUserData) ->
    dfp_read_field_def_client_authorize_request(Bin,
                                                0,
                                                0,
                                                id('$undef', TrUserData),
...
dfp_read_field_def_client_authorize_request(<<10,
                                              Rest/binary>>,
                                            Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                            TrUserData) ->
    d_field_client_authorize_request_clientinfo(Rest,
                                                Z1,
                                                Z2,
                                                F@_1,
                                                F@_2,
                                                ...
                                                F@_4,
                                                TrUserData);
dfp_read_field_def_client_authorize_request(<<16,
                                              Rest/binary>>,
                                            Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                            TrUserData) ->
    d_field_client_authorize_request_type(Rest,
                                          Z1,
                                          Z2,
                                          F@_1,
                                          F@_2,
                                          ...
                                          F@_4,
                                          TrUserData);
dfp_read_field_def_client_authorize_request(<<26,
                                              Rest/binary>>,
                                            Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                            TrUserData) ->
    d_field_client_authorize_request_topic(Rest,
                                           Z1,
                                           Z2,
                                           F@_1,
                                           F@_2,
                                           ...
                                           F@_4,
                                           TrUserData);
dfp_read_field_def_client_authorize_request(<<32,
                                              Rest/binary>>,
                                            Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                            TrUserData) ->
    d_field_client_authorize_request_result(Rest,
                                            Z1,
                                            Z2,
                                            F@_1,
                                            F@_2,
                                            ...
                                            F@_4,
                                            TrUserData);
dfp_read_field_def_client_authorize_request(<<>>, 0, 0,
                                            F@_1, F@_2, F@_3, F@_4, _) ->
    S1 = #{type => F@_2, topic => F@_3, result => F@_4},
    if F@_1 == '$undef' -> S1;
       true -> S1#{clientinfo => F@_1}
    end;
dfp_read_field_def_client_authorize_request(Other, Z1,
                                            Z2, F@_1, F@_2, F@_3, F@_4,
                                            TrUserData) ->
    dg_read_field_def_client_authorize_request(Other,
                                               Z1,
                                               Z2,
                                               F@_1,
                                               F@_2,
...
dg_read_field_def_client_authorize_request(<<1:1, X:7,
                                             Rest/binary>>,
                                           N, Acc, F@_1, F@_2, F@_3, F@_4,
                                           TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_client_authorize_request(Rest,
                                               N + 7,
                                               X bsl N + Acc,
                                               F@_1,
                                               F@_2,
                                               ...
                                               F@_4,
                                               TrUserData);
dg_read_field_def_client_authorize_request(<<0:1, X:7,
                                             Rest/binary>>,
                                           N, Acc, F@_1, F@_2, F@_3, F@_4,
                                           TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    skip_varint_client_authorize_request(Rest,
                                                         0,
                                                         0,
                                                         F@_1,
                                                         F@_2,
                                                         ...
                                                         TrUserData);
                1 ->
                    skip_64_client_authorize_request(Rest,
                                                     0,
                                                     0,
                                                     F@_1,
                                                     F@_2,
                                                     ...
                                                     TrUserData);
                2 ->
                    skip_length_delimited_client_authorize_request(Rest,
                                                                   0,
                                                                   0,
                                                                   F@_1,
                                                                   F@_2,
                                                                   ...
                                                                   TrUserData);
                3 ->
                    skip_group_client_authorize_request(Rest,
                                                        Key bsr 3,
                                                        0,
                                                        F@_1,
                                                        F@_2,
                                                        ...
                                                        TrUserData);
                5 ->
                    skip_32_client_authorize_request(Rest,
                                                     0,
                                                     0,
                                                     F@_1,
                                                     F@_2,
...
dg_read_field_def_client_authorize_request(<<>>, 0, 0,
                                           F@_1, F@_2, F@_3, F@_4, _) ->
    S1 = #{type => F@_2, topic => F@_3, result => F@_4},
    if F@_1 == '$undef' -> S1;
       true -> S1#{clientinfo => F@_1}
...
d_field_client_authorize_request_clientinfo(<<1:1, X:7,
                                              Rest/binary>>,
                                            N, Acc, F@_1, F@_2, F@_3, F@_4,
                                            TrUserData)
    when N < 57 ->
    d_field_client_authorize_request_clientinfo(Rest,
                                                ...
                                                F@_4,
                                                TrUserData);
d_field_client_authorize_request_clientinfo(<<0:1, X:7,
                                              Rest/binary>>,
    ...
    dfp_read_field_def_client_authorize_request(RestF,
                                                0,
                                                0,
                                                if Prev == '$undef' ->
                                                       NewFValue;
...
d_field_client_authorize_request_type(<<1:1, X:7,
                                        Rest/binary>>,
                                      N, Acc, F@_1, F@_2, F@_3, F@_4,
                                      TrUserData)
    when N < 57 ->
    d_field_client_authorize_request_type(Rest,
                                          ...
                                          F@_4,
                                          TrUserData);
d_field_client_authorize_request_type(<<0:1, X:7,
                                        Rest/binary>>,
                                      N, Acc, F@_1, _, F@_3, F@_4,
                                      TrUserData) ->
    {NewFValue, RestF} =
        {id('d_enum_client_authorize_request.AuthorizeReqType'(begin
...
d_field_client_authorize_request_topic(<<1:1, X:7,
                                         Rest/binary>>,
                                       N, Acc, F@_1, F@_2, F@_3, F@_4,
                                       TrUserData)
    when N < 57 ->
    d_field_client_authorize_request_topic(Rest,
                                           ...
                                           F@_4,
                                           TrUserData);
d_field_client_authorize_request_topic(<<0:1, X:7,
                                         Rest/binary>>,
...
d_field_client_authorize_request_result(<<1:1, X:7,
                                          Rest/binary>>,
                                        N, Acc, F@_1, F@_2, F@_3, F@_4,
                                        TrUserData)
    when N < 57 ->
    d_field_client_authorize_request_result(Rest,
                                            ...
                                            F@_4,
                                            TrUserData);
d_field_client_authorize_request_result(<<0:1, X:7,
                                          Rest/binary>>,
...
skip_varint_client_authorize_request(<<1:1, _:7,
                                       Rest/binary>>,
                                     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                     TrUserData) ->
    skip_varint_client_authorize_request(Rest,
                                         ...
                                         F@_4,
                                         TrUserData);
skip_varint_client_authorize_request(<<0:1, _:7,
                                       Rest/binary>>,
                                     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                     TrUserData) ->
    dfp_read_field_def_client_authorize_request(Rest,
                                                Z1,
                                                Z2,
                                                F@_1,
                                                F@_2,
...
skip_length_delimited_client_authorize_request(<<1:1,
                                                 X:7, Rest/binary>>,
                                               N, Acc, F@_1, F@_2, F@_3, F@_4,
                                               TrUserData)
    when N < 57 ->
    skip_length_delimited_client_authorize_request(Rest,
                                                   ...
                                                   F@_4,
                                                   TrUserData);
skip_length_delimited_client_authorize_request(<<0:1,
                                                 X:7, Rest/binary>>,
                                               N, Acc, F@_1, F@_2, F@_3, F@_4,
                                               TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_client_authorize_request(Rest2,
                                                0,
                                                0,
                                                F@_1,
                                                F@_2,
...
skip_group_client_authorize_request(Bin, FNum, Z2, F@_1,
...
skip_32_client_authorize_request(<<_:32, Rest/binary>>,
...
skip_64_client_authorize_request(<<_:64, Rest/binary>>,
                                 Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dfp_read_field_def_client_authorize_request(Rest,
                                                Z1,
                                                Z2,
...
decode_msg_session_takenover_request(Bin, TrUserData) ->
    dfp_read_field_def_session_takenover_request(Bin,
                                                 0,
                                                 0,
                                                 id('$undef', TrUserData),
                                                 TrUserData).

dfp_read_field_def_session_takenover_request(<<10,
                                               Rest/binary>>,
                                             Z1, Z2, F@_1, TrUserData) ->
    d_field_session_takenover_request_clientinfo(Rest,
                                                 Z1,
                                                 Z2,
                                                 F@_1,
                                                 TrUserData);
dfp_read_field_def_session_takenover_request(<<>>, 0, 0,
                                             F@_1, _) ->
    S1 = #{},
    if F@_1 == '$undef' -> S1;
       true -> S1#{clientinfo => F@_1}
    end;
dfp_read_field_def_session_takenover_request(Other, Z1,
                                             Z2, F@_1, TrUserData) ->
    dg_read_field_def_session_takenover_request(Other,
                                                Z1,
                                                Z2,
                                                F@_1,
                                                TrUserData).

dg_read_field_def_session_takenover_request(<<1:1, X:7,
                                              Rest/binary>>,
                                            N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_session_takenover_request(Rest,
                                                N + 7,
                                                X bsl N + Acc,
                                                F@_1,
                                                TrUserData);
dg_read_field_def_session_takenover_request(<<0:1, X:7,
                                              Rest/binary>>,
                                            N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    skip_varint_session_takenover_request(Rest,
                                                          0,
                                                          0,
                                                          F@_1,
                                                          TrUserData);
                1 ->
                    skip_64_session_takenover_request(Rest,
                                                      0,
                                                      0,
                                                      F@_1,
                                                      TrUserData);
                2 ->
                    skip_length_delimited_session_takenover_request(Rest,
                                                                    0,
                                                                    0,
                                                                    F@_1,
                                                                    TrUserData);
                3 ->
                    skip_group_session_takenover_request(Rest,
                                                         Key bsr 3,
                                                         0,
                                                         F@_1,
                                                         TrUserData);
                5 ->
                    skip_32_session_takenover_request(Rest,
                                                      0,
                                                      0,
                                                      F@_1,
                                                      TrUserData)
...
dg_read_field_def_session_takenover_request(<<>>, 0, 0,
                                            F@_1, _) ->
    S1 = #{},
    if F@_1 == '$undef' -> S1;
       true -> S1#{clientinfo => F@_1}
...
d_field_session_takenover_request_clientinfo(<<1:1, X:7,
                                               Rest/binary>>,
                                             N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_session_takenover_request_clientinfo(Rest,
                                                 ...
                                                 F@_1,
                                                 TrUserData);
d_field_session_takenover_request_clientinfo(<<0:1, X:7,
                                               Rest/binary>>,
                                             N, Acc, Prev, TrUserData) ->
    {NewFValue, RestF} = begin
                             Len = X bsl N + Acc,
    ...
    dfp_read_field_def_session_takenover_request(RestF,
                                                 0,
                                                 0,
                                                 if Prev == '$undef' ->
                                                        NewFValue;
...
skip_varint_session_takenover_request(<<1:1, _:7,
                                        Rest/binary>>,
                                      Z1, Z2, F@_1, TrUserData) ->
    skip_varint_session_takenover_request(Rest,
                                          Z1,
                                          ...
                                          F@_1,
                                          TrUserData);
skip_varint_session_takenover_request(<<0:1, _:7,
                                        Rest/binary>>,
                                      Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_session_takenover_request(Rest,
                                                 Z1,
                                                 Z2,
                                                 F@_1,
                                                 TrUserData).

skip_length_delimited_session_takenover_request(<<1:1,
                                                  X:7, Rest/binary>>,
                                                N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_session_takenover_request(Rest,
                                                    ...
                                                    F@_1,
                                                    TrUserData);
skip_length_delimited_session_takenover_request(<<0:1,
                                                  X:7, Rest/binary>>,
                                                N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_session_takenover_request(Rest2,
                                                 0,
                                                 0,
                                                 F@_1,
                                                 TrUserData).

skip_group_session_takenover_request(Bin, FNum, Z2,
                                     F@_1, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_session_takenover_request(Rest,
                                                 0,
...
skip_32_session_takenover_request(<<_:32, Rest/binary>>,
                                  Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_session_takenover_request(Rest,
                                                 Z1,
                                                 Z2,
...
skip_64_session_takenover_request(<<_:64, Rest/binary>>,
                                  Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_session_takenover_request(Rest,
                                                 Z1,
                                                 Z2,
...
dfp_read_field_def_broker_info(<<18, Rest/binary>>, Z1,
    ...
    d_field_broker_info_sysdescr(Rest,
                                 ...
                                 F@_4,
                                 TrUserData);
dfp_read_field_def_broker_info(<<24, Rest/binary>>, Z1,
                               Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
...
decode_msg_message(Bin, TrUserData) ->
    dfp_read_field_def_message(Bin,
                               ...
                               id(<<>>, TrUserData),
                               id(0, TrUserData),
                               'tr_decode_init_default_message.headers'([],
                                                                        TrUserData),
                               TrUserData).
...
dfp_read_field_def_message(<<>>, 0, 0, F@_1, F@_2, F@_3,
    ...
    #{node => F@_1, id => F@_2, qos => F@_3, from => F@_4,
      ...
      headers =>
          'tr_decode_repeated_finalize_message.headers'(R1,
                                                        TrUserData)};
...
d_field_message_headers(<<1:1, X:7, Rest/binary>>, N,
                        Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
                        TrUserData)
    when N < 57 ->
    d_field_message_headers(Rest,
                            ...
                            F@_8,
                            TrUserData);
d_field_message_headers(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_message(RestF,
                               ...
                               F@_6,
                               F@_7,
                               'tr_decode_repeated_add_elem_message.headers'(NewFValue,
                                                                             Prev,
                                                                             TrUserData),
                               TrUserData).
...
'd_enum_client_authorize_request.AuthorizeReqType'(0) ->
    'PUBLISH';
'd_enum_client_authorize_request.AuthorizeReqType'(1) ->
    'SUBSCRIBE';
'd_enum_client_authorize_request.AuthorizeReqType'(V) ->
    V.
    ...
    case MsgName of
        ...
        client_authenticate_request ->
            merge_msg_client_authenticate_request(Prev,
                                                  ...
                                                  TrUserData);
        client_authorize_request ->
            merge_msg_client_authorize_request(Prev,
                                               New,
                                               TrUserData);
        client_subscribe_request ->
        ...
        session_discarded_request ->
            merge_msg_session_discarded_request(Prev,
                                                ...
                                                TrUserData);
        session_takenover_request ->
            merge_msg_session_takenover_request(Prev,
                                                New,
                                                TrUserData);
        session_terminated_request ->
...
-compile({nowarn_unused_function,merge_msg_client_authorize_request/3}).
merge_msg_client_authorize_request(PMsg, NMsg,
                                   TrUserData) ->
    S1 = #{},
    S2 = case {PMsg, NMsg} of
             {#{clientinfo := PFclientinfo},
...
-compile({nowarn_unused_function,merge_msg_session_takenover_request/3}).
merge_msg_session_takenover_request(PMsg, NMsg,
                                    TrUserData) ->
    S1 = #{},
    case {PMsg, NMsg} of
        {#{clientinfo := PFclientinfo},
...
merge_msg_message(PMsg, NMsg, TrUserData) ->
    ...
    case {PMsg, NMsg} of
        {#{headers := PFheaders}, #{headers := NFheaders}} ->
            S8#{headers =>
                    'tr_merge_message.headers'(PFheaders,
                                               NFheaders,
                                               TrUserData)};
        {_, #{headers := NFheaders}} ->
            S8#{headers => NFheaders};
        {#{headers := PFheaders}, _} ->
            S8#{headers => PFheaders};
        {_, _} -> S8
    end.
    ...
    case MsgName of
        ...
        client_authenticate_request ->
            v_msg_client_authenticate_request(Msg,
                                              ...
                                              TrUserData);
        client_authorize_request ->
            v_msg_client_authorize_request(Msg,
                                           [MsgName],
                                           TrUserData);
        client_subscribe_request ->
        ...
        session_discarded_request ->
            v_msg_session_discarded_request(Msg,
                                            ...
                                            TrUserData);
        session_takenover_request ->
            v_msg_session_takenover_request(Msg,
                                            [MsgName],
                                            TrUserData);
        session_terminated_request ->
...
-compile({nowarn_unused_function,v_msg_client_authorize_request/3}).
-dialyzer({nowarn_function,v_msg_client_authorize_request/3}).
v_msg_client_authorize_request(#{} = M, Path,
                               TrUserData) ->
    case M of
        #{clientinfo := F1} ->
            v_msg_client_info(F1, [clientinfo | Path], TrUserData);
    ...
    case M of
        #{type := F2} ->
            'v_enum_client_authorize_request.AuthorizeReqType'(F2,
                                                               [type | Path],
                                                               TrUserData);
        _ -> ok
    end,
    ...
    lists:foreach(fun (clientinfo) -> ok;
                  ...
                  maps:keys(M)),
    ok;
v_msg_client_authorize_request(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields,
                   [] -- maps:keys(M),
                   client_authorize_request},
                  M,
                  Path);
v_msg_client_authorize_request(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, client_authorize_request},
                  X,
                  Path).
...
-compile({nowarn_unused_function,v_msg_session_takenover_request/3}).
-dialyzer({nowarn_function,v_msg_session_takenover_request/3}).
v_msg_session_takenover_request(#{} = M, Path,
                                TrUserData) ->
    case M of
        #{clientinfo := F1} ->
            v_msg_client_info(F1, [clientinfo | Path], TrUserData);
    ...
    lists:foreach(fun (clientinfo) -> ok;
                  ...
                  maps:keys(M)),
    ok;
v_msg_session_takenover_request(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields,
                   [] -- maps:keys(M),
                   session_takenover_request},
                  M,
                  Path);
v_msg_session_takenover_request(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, session_takenover_request},
                  X,
                  Path).
...
v_msg_broker_info(#{} = M, Path, TrUserData) ->
    ...
    case M of
        #{uptime := F3} ->
            v_type_int64(F3, [uptime | Path], TrUserData);
        _ -> ok
    end,
    case M of
        #{datetime := F4} ->
...
-compile({nowarn_unused_function,'v_enum_client_authorize_request.AuthorizeReqType'/3}).
-dialyzer({nowarn_function,'v_enum_client_authorize_request.AuthorizeReqType'/3}).
'v_enum_client_authorize_request.AuthorizeReqType'('PUBLISH',
                                                   _Path, _TrUserData) ->
    ok;
'v_enum_client_authorize_request.AuthorizeReqType'('SUBSCRIBE',
                                                   _Path, _TrUserData) ->
    ok;
'v_enum_client_authorize_request.AuthorizeReqType'(V,
                                                   Path, TrUserData)
    when is_integer(V) ->
    v_type_sint32(V, Path, TrUserData);
'v_enum_client_authorize_request.AuthorizeReqType'(X,
                                                   Path, _TrUserData) ->
    mk_type_error({invalid_enum,
                   'client_authorize_request.AuthorizeReqType'},
                  X,
                  Path).
...
-compile({inline,'tr_decode_init_default_message.headers'/2}).
'tr_decode_init_default_message.headers'(_, _) ->
    mt_empty_map_m().

-compile({inline,'tr_merge_message.headers'/3}).
'tr_merge_message.headers'(X1, X2, _) ->
    mt_merge_maps_m(X1, X2).

-compile({inline,'tr_decode_repeated_finalize_message.headers'/2}).
'tr_decode_repeated_finalize_message.headers'(L,
                                              TrUserData) ->
    id(L, TrUserData).

-compile({inline,'tr_encode_message.headers'/2}).
'tr_encode_message.headers'(X, _) ->
    mt_map_to_list_m(X).

-compile({inline,'tr_decode_repeated_add_elem_message.headers'/3}).
'tr_decode_repeated_add_elem_message.headers'(Elem, L,
                                              _) ->
    mt_add_item_m(Elem, L).

-compile({inline,'tr_encode_message.headers[x]'/2}).
'tr_encode_message.headers[x]'(X, _) ->
...
get_msg_defs() ->
    [{{enum, 'client_authorize_request.AuthorizeReqType'},
     ...
     {{msg, broker_info},
      [#{name => version, fnum => 1, rnum => 2,
       ...
       #{name => sysdescr, fnum => 2, rnum => 3,
         type => string, occurrence => optional, opts => []},
       #{name => uptime, fnum => 3, rnum => 4, type => int64,
         occurrence => optional, opts => []},
...
find_msg_def(client_authenticate_request) ->
    [#{name => clientinfo, fnum => 1, rnum => 2,
     ...
     #{name => result, fnum => 2, rnum => 3, type => bool,
       occurrence => optional, opts => []}];
find_msg_def(client_authorize_request) ->
    [#{name => clientinfo, fnum => 1, rnum => 2,
       type => {msg, client_info}, occurrence => optional,
       opts => []},
     #{name => type, fnum => 2, rnum => 3,
...
find_msg_def(session_discarded_request) ->
    [#{name => clientinfo, fnum => 1, rnum => 2,
       type => {msg, client_info}, occurrence => optional,
       opts => []}];
find_msg_def(session_takenover_request) ->
    [#{name => clientinfo, fnum => 1, rnum => 2,
       type => {msg, client_info}, occurrence => optional,
       opts => []}];
...
find_enum_def('client_authorize_request.AuthorizeReqType') ->
    [{'PUBLISH', 0}, {'SUBSCRIBE', 1}];
...
enum_symbol_by_value('client_authorize_request.AuthorizeReqType',
                     Value) ->
    'enum_symbol_by_value_client_authorize_request.AuthorizeReqType'(Value);
enum_symbol_by_value('valued_response.ResponsedType',
                     Value) ->
    'enum_symbol_by_value_valued_response.ResponsedType'(Value).


enum_value_by_symbol('client_authorize_request.AuthorizeReqType',
                     Sym) ->
    'enum_value_by_symbol_client_authorize_request.AuthorizeReqType'(Sym);
enum_value_by_symbol('valued_response.ResponsedType',
                     Sym) ->
    'enum_value_by_symbol_valued_response.ResponsedType'(Sym).


'enum_symbol_by_value_client_authorize_request.AuthorizeReqType'(0) ->
    'PUBLISH';
'enum_symbol_by_value_client_authorize_request.AuthorizeReqType'(1) ->
    'SUBSCRIBE'.


'enum_value_by_symbol_client_authorize_request.AuthorizeReqType'('PUBLISH') ->
    0;
'enum_value_by_symbol_client_authorize_request.AuthorizeReqType'('SUBSCRIBE') ->
    1.
    ...
    {{service, 'emqx.exhook.v1.HookProvider'},
     [#{name => 'OnProviderLoaded',
      ...
      #{name => 'OnClientAuthenticate',
        ...
        output_stream => false, opts => []},
      #{name => 'OnClientAuthorize',
        input => client_authorize_request,
        output => valued_response, input_stream => false,
        output_stream => false, opts => []},
      ...
      #{name => 'OnSessionDiscarded',
        ...
        output => empty_success, input_stream => false,
        output_stream => false, opts => []},
      #{name => 'OnSessionTakenover',
        input => session_takenover_request,
        output => empty_success, input_stream => false,
        output_stream => false, opts => []},
...
'find_rpc_def_emqx.exhook.v1.HookProvider'('OnClientAuthenticate') ->
    #{name => 'OnClientAuthenticate',
      ...
      output => valued_response, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_emqx.exhook.v1.HookProvider'('OnClientAuthorize') ->
    #{name => 'OnClientAuthorize',
      input => client_authorize_request,
      output => valued_response, input_stream => false,
      output_stream => false, opts => []};
...
'find_rpc_def_emqx.exhook.v1.HookProvider'('OnSessionDiscarded') ->
    #{name => 'OnSessionDiscarded',
      ...
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_emqx.exhook.v1.HookProvider'('OnSessionTakenover') ->
    #{name => 'OnSessionTakenover',
      input => session_takenover_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
...
fqbins_to_service_and_rpc_name(<<"emqx.exhook.v1.HookProvider">>, <<"OnClientAuthorize">>) ->
...
fqbins_to_service_and_rpc_name(<<"emqx.exhook.v1.HookProvider">>, <<"OnSessionTakenover">>) ->
    {'emqx.exhook.v1.HookProvider', 'OnSessionTakenover'};
...
fqbin_to_msg_name(<<"emqx.exhook.v1.ClientAuthenticateRequest">>) ->
    client_authenticate_request;
fqbin_to_msg_name(<<"emqx.exhook.v1.ClientAuthorizeRequest">>) -> client_authorize_request;
...
fqbin_to_msg_name(<<"emqx.exhook.v1.SessionTakenoverRequest">>) -> session_takenover_request;
...
msg_name_to_fqbin(client_authorize_request) -> <<"emqx.exhook.v1.ClientAuthorizeRequest">>;
...
msg_name_to_fqbin(session_takenover_request) -> <<"emqx.exhook.v1.SessionTakenoverRequest">>;
...
fqbin_to_enum_name(<<"emqx.exhook.v1.ClientAuthorizeRequest.AuthorizeReqType">>) ->
    'client_authorize_request.AuthorizeReqType';
...
enum_name_to_fqbin('client_authorize_request.AuthorizeReqType') ->
    <<"emqx.exhook.v1.ClientAuthorizeRequest.AuthorizeReqType">>;
...
get_proto_by_msg_name_as_fqbin(<<"emqx.exhook.v1.SessionTakenoverRequest">>) -> "exhook";
...
get_proto_by_msg_name_as_fqbin(<<"emqx.exhook.v1.ClientAuthorizeRequest">>) -> "exhook";
...
get_proto_by_enum_name_as_fqbin(<<"emqx.exhook.v1.ClientAuthorizeRequest.AuthorizeReqType">>) -> "exhook";
