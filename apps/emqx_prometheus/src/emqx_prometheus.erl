...
%% @private start_at / expiry_at from emqx_license_checker:dump/0 are binary
%% "YYYY-MM-DD" (output of emqx_license_parser_v20220101:format_date/1).
%% Returns Unix epoch seconds at UTC midnight, or 0 on any parse failure.
