...
-spec clean_authz_cache_v3(node(), emqx_types:mtns(), emqx_types:clientid()) ->
    ok
    | {error, not_found}
    | {badrpc, _}.
clean_authz_cache_v3(Node, Mtns, ClientId) ->
    rpc:call(Node, emqx_authz_cache, drain_cache, [Mtns, ClientId]).
