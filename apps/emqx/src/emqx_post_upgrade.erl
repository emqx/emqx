...
-export([
    ...
    pr_17624_gcp_pubsub_consumer_worker_optvars/1,
    pr_19081_gcp_pubsub_consumer_worker_optvars/1
]).
...
-ignore_xref([
    ...
    {ecpool, workers, 1},
    {ecpool_worker, client, 1},
    {emqx_bridge_gcp_pubsub_impl_consumer, on_get_channels, 1}
]).
...
pr_17624_gcp_pubsub_consumer_worker_optvars(_FromVsn) ->
    %% Need this hack because rebar3's xref check apparently ignores `ignore_xref`
    %% attribute for these calls....
...
pr_19081_gcp_pubsub_consumer_worker_optvars(_FromVsn) ->
