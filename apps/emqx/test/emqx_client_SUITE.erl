...
-doc """
A node that is hot-patched to this version has no
`max_connect_user_properties` key in its zone configuration. The connection
modules then use the schema default.
""".
