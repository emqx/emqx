...
-module(emqx_bridge_redis_sentinel_action_info).
...
bridge_v1_type_name() -> redis_sentinel.

action_type_name() -> redis_sentinel_producer.

connector_type_name() -> redis_sentinel_producer.

schema_module() -> emqx_bridge_redis_sentinel_schema.
