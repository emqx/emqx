...
-module(emqx_bridge_redis_cluster_action_info).
...
bridge_v1_type_name() -> redis_cluster.

action_type_name() -> redis_cluster_producer.

connector_type_name() -> redis_cluster_producer.

schema_module() -> emqx_bridge_redis_cluster_schema.
