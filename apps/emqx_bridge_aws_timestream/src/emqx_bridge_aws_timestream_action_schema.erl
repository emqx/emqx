...
%%--------------------------------------------------------------------
-module(emqx_bridge_aws_timestream_action_schema).
...
fields(action) ->
    {?ACTION_TYPE,
        mk(
            ...
            #{
                desc => <<"AWS Timestream Action Config">>,
                required => false
            }
        )};
fields(?ACTION_TYPE) ->
...
fields(action_parameters) ->
    emqx_bridge_influxdb:fields(action_parameters).
