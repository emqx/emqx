...
authentication() ->
    sc(hoconsc:union(
         ...
         , hoconsc:ref(emqx_authn_mongodb, replica_set)
         , hoconsc:ref(emqx_authn_mongodb, sharded_cluster)
         ...
         , hoconsc:ref(emqx_authn_jwt, hmac_based)
         , hoconsc:ref(emqx_authn_jwt, public_key)
