...
lookup_v8(Namespace, ConfRootKey, BridgeType, BridgeName) ->
    case emqx_bridge_v2:lookup(Namespace, ConfRootKey, BridgeType, BridgeName) of
        {ok, Res} -> {ok, format_resource(ConfRootKey, Res, node())};
        Error -> Error
    end.
...
summary_from_local_node_v7(ConfRootKey) ->
    summary_v8(_Namespace = undefined, ConfRootKey).
...
wait_for_ready_local_node_v7(ConfRootKey, Type, Name) ->
    wait_for_ready_v8(_Namespace = undefined, ConfRootKey, Type, Name).
