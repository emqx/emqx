...
t_fallback_actions_cycles(_Config) ->
    ...
    ?check_trace(
        #{timetrap => 10_000},
        begin
            RulesMatched0 = emqx_metrics:val_global('rules.matched'),
            ActionsExecuted0 = emqx_metrics:val_global('actions.executed'),
            {ok, _} = emqx_connector:create(?global_ns, con_type(), ConnectorName, ConnectorConfig),
            ...
            RulesMatched1 = emqx_metrics:val_global('rules.matched'),
            ActionsExecuted1 = emqx_metrics:val_global('actions.executed'),
