...
null_badarg_test_() ->
    [
        ?_assertError(badarg, emqx_variform_bif:lower(undefined)),
        ?_assertError(badarg, emqx_variform_bif:lower(null)),
        ?_assertError(badarg, emqx_variform_bif:ltrim(undefined)),
        ?_assertError(badarg, emqx_variform_bif:ltrim(null)),
        ?_assertError(badarg, emqx_variform_bif:ltrim(undefined, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:ltrim(null, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:reverse(undefined)),
        ?_assertError(badarg, emqx_variform_bif:reverse(null)),
        ?_assertError(badarg, emqx_variform_bif:rtrim(undefined)),
        ?_assertError(badarg, emqx_variform_bif:rtrim(null)),
        ?_assertError(badarg, emqx_variform_bif:rtrim(undefined, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:rtrim(null, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:rm_prefix(undefined, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:rm_prefix(null, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:strlen(undefined)),
        ?_assertError(badarg, emqx_variform_bif:strlen(null)),
        ?_assertError(badarg, emqx_variform_bif:substr(undefined, 1)),
        ?_assertError(badarg, emqx_variform_bif:substr(null, 1)),
        ?_assertError(badarg, emqx_variform_bif:substr(undefined, 1, 2)),
        ?_assertError(badarg, emqx_variform_bif:substr(null, 1, 2)),
        ?_assertError(badarg, emqx_variform_bif:trim(undefined)),
        ?_assertError(badarg, emqx_variform_bif:trim(null)),
        ?_assertError(badarg, emqx_variform_bif:trim(undefined, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:trim(null, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:upper(undefined)),
        ?_assertError(badarg, emqx_variform_bif:upper(null)),
        ?_assertError(badarg, emqx_variform_bif:split(undefined, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:split(null, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:split(undefined, <<"a">>, <<"notrim">>)),
        ?_assertError(badarg, emqx_variform_bif:split(null, <<"a">>, <<"notrim">>)),
        ?_assertError(badarg, emqx_variform_bif:tokens(undefined, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:tokens(null, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:tokens(undefined, <<"a">>, <<"nocrlf">>)),
        ?_assertError(badarg, emqx_variform_bif:tokens(null, <<"a">>, <<"nocrlf">>)),
        ?_assertError(badarg, emqx_variform_bif:pad(undefined, 1)),
        ?_assertError(badarg, emqx_variform_bif:pad(null, 1)),
        ?_assertError(badarg, emqx_variform_bif:pad(undefined, 1, <<"trailing">>)),
        ?_assertError(badarg, emqx_variform_bif:pad(null, 1, <<"trailing">>)),
        ?_assertError(badarg, emqx_variform_bif:pad(undefined, 1, <<"trailing">>, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:pad(null, 1, <<"trailing">>, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:replace(undefined, <<"a">>, <<"b">>)),
        ?_assertError(badarg, emqx_variform_bif:replace(null, <<"a">>, <<"b">>)),
        ?_assertError(badarg, emqx_variform_bif:replace(undefined, <<"a">>, <<"b">>, <<"all">>)),
        ?_assertError(badarg, emqx_variform_bif:replace(null, <<"a">>, <<"b">>, <<"all">>)),
        ?_assertError(badarg, emqx_variform_bif:regex_match(undefined, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:regex_match(null, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:regex_replace(undefined, <<"a">>, <<"b">>)),
        ?_assertError(badarg, emqx_variform_bif:regex_replace(null, <<"a">>, <<"b">>)),
        ?_assertError(badarg, emqx_variform_bif:regex_extract(undefined, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:regex_extract(null, <<"a">>)),
        ?_assertError(badarg, emqx_variform_bif:ascii(undefined)),
        ?_assertError(badarg, emqx_variform_bif:ascii(null)),
        ?_assertError(badarg, emqx_variform_bif:find(undefined, <<"a">>)),
