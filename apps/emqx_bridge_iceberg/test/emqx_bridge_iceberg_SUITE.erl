...
rule_sql_for_schema2(RuleTopic) ->
    render(
        <<
            "SELECT"
...
create_rule_for_schema2(TCConfig, RuleTopic) ->
    Opts = #{
        sql => rule_sql_for_schema2(RuleTopic)
    },
...
t_consecutive_writes(Config) ->
    ...
    {ok, _} = create_rule_for_schema2(Config, RuleTopic),
