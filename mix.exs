defmodule EMQXUmbrella.MixProject do
  ...
  def common_dep(:ekka), do: {:ekka, github: "emqx/ekka", tag: "0.24.1", override: true}
  ...
  def common_dep(:minirest),
    do: {:minirest, github: "emqx/minirest", tag: "1.4.11", override: true}
  ...
  defp data_integration_deps() do
    [
      ...
      {:greptimedb, github: "emqx/greptimedb-ingester-erl", tag: "v0.2.3-emqx.1", override: true},
